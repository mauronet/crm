...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.creado_por'
        db.delete_column(u'videos_video', 'creado_por_id')

        # Adding field 'Video.creado_para'
        db.add_column(u'videos_video', 'creado_para',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='defaultEntidad', null=True, blank=True, to=orm['entidades.Entidad']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Video.creado_por'
        db.add_column(u'videos_video', 'creado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='defaultEntidad', to=orm['entidades.Entidad']),
                      keep_default=False)

        # Deleting field 'Video.creado_para'
        db.delete_column(u'videos_video', 'creado_para_id')
    ...
    models = {
        ...
        u'videos.video': {
            ...
            'creado_para': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'defaultEntidad'", 'null': 'True', 'blank': 'True', 'to': u"orm['entidades.Entidad']"}),
