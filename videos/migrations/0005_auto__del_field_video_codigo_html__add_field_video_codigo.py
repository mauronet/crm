...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.codigo_html'
        db.delete_column(u'videos_video', 'codigo_html')

        # Adding field 'Video.codigo'
        db.add_column(u'videos_video', 'codigo',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Video.codigo_html'
        db.add_column(u'videos_video', 'codigo_html',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Deleting field 'Video.codigo'
        db.delete_column(u'videos_video', 'codigo')
