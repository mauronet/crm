...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.imagen_previa'
        db.delete_column(u'videos_video', 'imagen_previa')


        # Changing field 'Video.codigo_html'
        db.alter_column(u'videos_video', 'codigo_html', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'Video.imagen_previa'
        db.add_column(u'videos_video', 'imagen_previa',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'Video.codigo_html'
        db.alter_column(u'videos_video', 'codigo_html', self.gf('django.db.models.fields.TextField')())
