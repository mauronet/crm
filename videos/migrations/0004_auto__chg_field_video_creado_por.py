...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.creado_por'
        db.alter_column(u'videos_video', 'creado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entidades.Entidad']))

    def backwards(self, orm):

        # Changing field 'Video.creado_por'
        db.alter_column(u'videos_video', 'creado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entidades.Entidad']))
