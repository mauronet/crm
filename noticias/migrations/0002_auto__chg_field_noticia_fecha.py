...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Noticia.fecha'
        db.alter_column(u'noticias_noticia', 'fecha', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Noticia.fecha'
        db.alter_column(u'noticias_noticia', 'fecha', self.gf('django.db.models.fields.DateField')())
