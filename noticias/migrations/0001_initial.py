...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'noticias_noticia', (
            ...
            ('imagen_principal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='imagenprincipal_noticias', to=orm['imagenes.Imagen'])),
        ))
        db.send_create_signal(u'noticias', ['Noticia'])

        # Adding M2M table for field comentarios on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_comentarios')
        ...
        db.create_unique(m2m_table_name, ['noticia_id', 'comentario_id'])

        # Adding M2M table for field categorias on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_categorias')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('categoria', models.ForeignKey(orm[u'categorias.categoria'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'categoria_id'])

        # Adding M2M table for field tags on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('tag', models.ForeignKey(orm[u'tags.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'tag_id'])

        # Adding M2M table for field franjas on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_franjas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('franja', models.ForeignKey(orm[u'franjas.franja'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'franja_id'])

        # Adding M2M table for field entidades on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_entidades')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('entidad', models.ForeignKey(orm[u'entidades.entidad'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'entidad_id'])

        # Adding M2M table for field imagenes_adicionales on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_imagenes_adicionales')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('imagen', models.ForeignKey(orm[u'imagenes.imagen'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'imagen_id'])

        # Adding M2M table for field videos on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_videos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('video', models.ForeignKey(orm[u'videos.video'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'video_id'])

        # Adding M2M table for field documentos on 'Noticia'
        m2m_table_name = db.shorten_name(u'noticias_noticia_documentos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'noticias.noticia'], null=False)),
            ('documento', models.ForeignKey(orm[u'documentos.documento'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'documento_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field comentarios on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_comentarios'))

        # Removing M2M table for field categorias on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_categorias'))

        # Removing M2M table for field tags on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_tags'))

        # Removing M2M table for field franjas on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_franjas'))

        # Removing M2M table for field entidades on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_entidades'))

        # Removing M2M table for field imagenes_adicionales on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_imagenes_adicionales'))

        # Removing M2M table for field videos on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_videos'))

        # Removing M2M table for field documentos on 'Noticia'
        db.delete_table(db.shorten_name(u'noticias_noticia_documentos'))
    ...
    models = {
        ...
        u'noticias.noticia': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen_principal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'imagenprincipal_noticias'", 'to': u"orm['imagenes.Imagen']"}),
