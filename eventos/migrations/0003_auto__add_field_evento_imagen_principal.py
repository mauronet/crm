...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evento.imagen_principal'
        db.add_column(u'eventos_evento', 'imagen_principal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='imagenprincipal_eventos', to=orm['imagenes.Imagen']),
                      keep_default=False)

        # Removing M2M table for field imagenes on 'Evento'
        db.delete_table(db.shorten_name(u'eventos_evento_imagenes'))

        # Adding M2M table for field imagenes_adicionales on 'Evento'
        m2m_table_name = db.shorten_name(u'eventos_evento_imagenes_adicionales')
    ...
    def backwards(self, orm):
        # Deleting field 'Evento.imagen_principal'
        db.delete_column(u'eventos_evento', 'imagen_principal_id')
        ...
        # Removing M2M table for field imagenes_adicionales on 'Evento'
        db.delete_table(db.shorten_name(u'eventos_evento_imagenes_adicionales'))
    ...
    models = {
        ...
        u'eventos.evento': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen_principal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'imagenprincipal_eventos'", 'to': u"orm['imagenes.Imagen']"}),
