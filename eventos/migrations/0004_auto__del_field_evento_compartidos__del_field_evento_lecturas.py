...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Evento.compartidos'
        db.delete_column(u'eventos_evento', 'compartidos')

        # Deleting field 'Evento.lecturas'
        db.delete_column(u'eventos_evento', 'lecturas')


    def backwards(self, orm):
        # Adding field 'Evento.compartidos'
        db.add_column(u'eventos_evento', 'compartidos',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evento.lecturas'
        db.add_column(u'eventos_evento', 'lecturas',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
