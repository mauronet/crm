...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Programa.video'
        db.alter_column(u'programas_programa', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'], null=True))

    def backwards(self, orm):

        # Changing field 'Programa.video'
        db.alter_column(u'programas_programa', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['videos.Video']))
