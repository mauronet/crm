...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Programa.entidad'
        db.add_column(u'programas_programa', 'entidad',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entidades.Entidad'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Programa.entidad'
        db.delete_column(u'programas_programa', 'entidad_id')
