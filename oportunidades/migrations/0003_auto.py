...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field imagenes_adicionales on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_imagenes_adicionales')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field imagenes_adicionales on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_imagenes_adicionales'))
