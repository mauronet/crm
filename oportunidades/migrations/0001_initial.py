...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Oportunidad'
        db.create_table(u'oportunidades_oportunidad', (
        ...
        db.send_create_signal(u'oportunidades', ['Oportunidad'])

        # Adding M2M table for field comentarios on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_comentarios')
        ...
        db.create_unique(m2m_table_name, ['oportunidad_id', 'comentario_id'])

        # Adding M2M table for field categorias on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_categorias')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
            ('categoria', models.ForeignKey(orm[u'categorias.categoria'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidad_id', 'categoria_id'])

        # Adding M2M table for field tags on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
            ('tag', models.ForeignKey(orm[u'tags.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidad_id', 'tag_id'])

        # Adding M2M table for field franjas on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_franjas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
            ('franja', models.ForeignKey(orm[u'franjas.franja'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidad_id', 'franja_id'])
        ...
        # Adding M2M table for field imagenes on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_imagenes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
            ('imagen', models.ForeignKey(orm[u'imagenes.imagen'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidad_id', 'imagen_id'])

        # Adding M2M table for field videos on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_videos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
            ('video', models.ForeignKey(orm[u'videos.video'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidad_id', 'video_id'])

        # Adding M2M table for field documentos on 'Oportunidad'
        m2m_table_name = db.shorten_name(u'oportunidades_oportunidad_documentos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidad', models.ForeignKey(orm[u'oportunidades.oportunidad'], null=False)),
            ('documento', models.ForeignKey(orm[u'documentos.documento'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidad_id', 'documento_id'])


    def backwards(self, orm):
        # Deleting model 'Oportunidad'
        db.delete_table(u'oportunidades_oportunidad')

        # Removing M2M table for field comentarios on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_comentarios'))

        # Removing M2M table for field categorias on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_categorias'))

        # Removing M2M table for field tags on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_tags'))

        # Removing M2M table for field franjas on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_franjas'))
        ...
        # Removing M2M table for field imagenes on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_imagenes'))

        # Removing M2M table for field videos on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_videos'))

        # Removing M2M table for field documentos on 'Oportunidad'
        db.delete_table(db.shorten_name(u'oportunidades_oportunidad_documentos'))
