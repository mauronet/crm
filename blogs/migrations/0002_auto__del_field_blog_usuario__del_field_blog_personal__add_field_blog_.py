...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blog.usuario'
        db.delete_column(u'blogs_blog', 'usuario_id')

        # Deleting field 'Blog.personal'
        db.delete_column(u'blogs_blog', 'personal')

        # Adding field 'Blog.entidad'
        db.add_column(u'blogs_blog', 'entidad',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['entidades.Entidad'], blank=True),
                      keep_default=False)

        # Adding field 'Blog.usuario_administrador'
        db.add_column(u'blogs_blog', 'usuario_administrador',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['userprofiles.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Blog.usuario'
        db.add_column(u'blogs_blog', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['userprofiles.UserProfile']),
                      keep_default=False)

        # Adding field 'Blog.personal'
        db.add_column(u'blogs_blog', 'personal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Blog.entidad'
        db.delete_column(u'blogs_blog', 'entidad_id')

        # Deleting field 'Blog.usuario_administrador'
        db.delete_column(u'blogs_blog', 'usuario_administrador_id')
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'entidad': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entidades.Entidad']", 'blank': 'True'}),
            ...
            'usuario_administrador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['userprofiles.UserProfile']"})
        },
