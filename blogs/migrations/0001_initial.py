...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blogs_blog', (
            ...
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofiles.UserProfile'])),
            ('personal', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'blogs', ['Blog'])

        # Adding M2M table for field entradas on 'Blog'
        m2m_table_name = db.shorten_name(u'blogs_blog_entradas')
        ...
        db.create_unique(m2m_table_name, ['blog_id', 'entradablog_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field entradas on 'Blog'
        db.delete_table(db.shorten_name(u'blogs_blog_entradas'))
