...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blogs_blog', 'descripcion',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Blog.administrador'
        db.add_column(u'blogs_blog', 'administrador',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['userprofiles.UserProfile'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.descripcion'
        db.delete_column(u'blogs_blog', 'descripcion')

        # Deleting field 'Blog.administrador'
        db.delete_column(u'blogs_blog', 'administrador_id')
