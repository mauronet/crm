...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Imagen.creado_para'
        db.add_column(u'imagenes_imagen', 'creado_para',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Imagen.creado_para'
        db.delete_column(u'imagenes_imagen', 'creado_para_id')
