...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.anotaciones_internas'
        db.add_column(u'userprofiles_userprofile', 'anotaciones_internas',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.anotaciones_internas'
        db.delete_column(u'userprofiles_userprofile', 'anotaciones_internas')
