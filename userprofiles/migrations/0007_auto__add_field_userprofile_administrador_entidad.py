...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.administrador_entidad'
        db.add_column(u'userprofiles_userprofile', 'administrador_entidad',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.administrador_entidad'
        db.delete_column(u'userprofiles_userprofile', 'administrador_entidad')
