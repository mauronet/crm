...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.entidad'
        db.alter_column(u'userprofiles_userprofile', 'entidad_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entidades.Entidad'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.entidad'
        db.alter_column(u'userprofiles_userprofile', 'entidad_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['entidades.Entidad']))
