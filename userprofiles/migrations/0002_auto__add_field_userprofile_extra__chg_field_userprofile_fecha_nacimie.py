...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofiles_userprofile', 'extra',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)


        # Changing field 'UserProfile.fecha_nacimiento'
        db.alter_column(u'userprofiles_userprofile', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.extra'
        db.delete_column(u'userprofiles_userprofile', 'extra')


        # Changing field 'UserProfile.fecha_nacimiento'
        db.alter_column(u'userprofiles_userprofile', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 6, 13, 0, 0)))
