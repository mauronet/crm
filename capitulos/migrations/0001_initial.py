...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'capitulos_capitulo', (
            ...
            ('produccion', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('duracion', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'])),
        ))
        db.send_create_signal(u'capitulos', ['Capitulo'])


    def backwards(self, orm):
        # Deleting model 'Capitulo'
        db.delete_table(u'capitulos_capitulo')
