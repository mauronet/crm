...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Documento.creado_para'
        db.add_column(u'documentos_documento', 'creado_para',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['entidades.Entidad'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Documento.creado_para'
        db.delete_column(u'documentos_documento', 'creado_para_id')
