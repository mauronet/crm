...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntradaBlog.compartidos'
        db.delete_column(u'entradas_blogs_entradablog', 'compartidos')

        # Deleting field 'EntradaBlog.lecturas'
        db.delete_column(u'entradas_blogs_entradablog', 'lecturas')


    def backwards(self, orm):
        # Adding field 'EntradaBlog.compartidos'
        db.add_column(u'entradas_blogs_entradablog', 'compartidos',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EntradaBlog.lecturas'
        db.add_column(u'entradas_blogs_entradablog', 'lecturas',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
