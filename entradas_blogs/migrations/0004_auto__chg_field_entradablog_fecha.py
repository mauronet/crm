...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntradaBlog.fecha'
        db.alter_column(u'entradas_blogs_entradablog', 'fecha', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'EntradaBlog.fecha'
        db.alter_column(u'entradas_blogs_entradablog', 'fecha', self.gf('django.db.models.fields.DateField')())
