...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntradaBlog.imagen_principal'
        db.add_column(u'entradas_blogs_entradablog', 'imagen_principal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='imagenprincipal_entrada_blog', to=orm['imagenes.Imagen']),
                      keep_default=False)
        ...
        # Adding M2M table for field imagenes_adicionales on 'EntradaBlog'
        m2m_table_name = db.shorten_name(u'entradas_blogs_entradablog_imagenes_adicionales')
    ...
    def backwards(self, orm):
        # Deleting field 'EntradaBlog.imagen_principal'
        db.delete_column(u'entradas_blogs_entradablog', 'imagen_principal_id')
        ...
        # Removing M2M table for field imagenes_adicionales on 'EntradaBlog'
        db.delete_table(db.shorten_name(u'entradas_blogs_entradablog_imagenes_adicionales'))
